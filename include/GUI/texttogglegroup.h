...
{
	public:
		TextToggleGroup(std::string top_text, std::vector<std::string> texts, const int x, const int y, bool only_one_has_to_be_checked, sdl::Renderer& renderer, std::vector<std::function<void(Ui* ui)>> callback_functions);
...
template<size_t N>
TextToggleGroup<N>::TextToggleGroup(std::string top_text, std::vector<std::string> texts, const int x, const int y, bool only_one_has_to_be_checked, sdl::Renderer& renderer, std::vector<std::function<void(Ui* ui)>> callback_functions)
