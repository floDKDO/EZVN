...
{
	public:
		CharacterDefinition(const std::string_view character_variable, const std::string_view character_name, const std::string_view character_path, const SDL_Color namebox_text_color = constants::namebox_text_color_, const std::string_view textbox_path = constants::textbox_image_, const std::string_view namebox_path = constants::namebox_image_);
		...
		SDL_Color initial_namebox_text_color_;
