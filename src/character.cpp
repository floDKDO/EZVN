...
Character::Character(const CharacterDefinition& character_definition, sdl::Renderer& renderer)
	...
	, properties_{character_definition.initial_name_, constants::default_zorder_, character_definition.initial_textbox_path_, character_definition.initial_namebox_path_, "none", false, false}, character_(character_definition.character_path_, 0, 0, renderer)
{}
