...
Checkbox::Checkbox(const std::string_view text, const int x, const int y, const bool is_checked, sdl::Renderer& renderer, std::function<void(Ui* ui)> callback_function)
	: Checkable(is_checked, renderer), normal_(constants::checkbox_normal_, x, y, renderer), selected_(constants::checkbox_selected_, x, y, renderer), pressed_(constants::checkbox_pressed_, x, y, renderer),
