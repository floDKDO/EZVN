...
ConfirmationPopUp::ConfirmationPopUp(const std::string_view text, sdl::Renderer& renderer, std::function<void(Ui* ui)> callback_function)
	: Ui(text, renderer), is_confirmationpopup_visible_(false),
