...
UiWidget::UiWidget(sdl::Renderer& renderer)
...
void UiWidget::on_pointer_down(PointerEventData pointer_event_data)
{
	state_ = State::PRESSED;
	on_pointer_down_hook_end(pointer_event_data);
}

void UiWidget::on_pointer_enter(PointerEventData pointer_event_data)
{
	state_ = State::SELECTED;
	on_pointer_enter_hook_end(pointer_event_data);
}

void UiWidget::on_pointer_exit(PointerEventData pointer_event_data)
{
...
void UiWidget::on_up_pressed()
{
	on_up_pressed_hook_end();
}

void UiWidget::on_down_pressed()
{
	on_down_pressed_hook_end();
}

void UiWidget::on_left_pressed()
{
	on_left_pressed_hook_end();
}

void UiWidget::on_right_pressed()
{
	on_right_pressed_hook_end();
}

void UiWidget::on_enter_pressed()
{
	state_ = State::PRESSED;
	on_enter_pressed_hook_end();
}

void UiWidget::on_up_released()
{
	on_up_released_hook_end();
}

void UiWidget::on_down_released()
{
	on_down_released_hook_end();
}

void UiWidget::on_left_released()
{
	on_left_released_hook_end();
}

void UiWidget::on_right_released()
{
	on_right_released_hook_end();
}

void UiWidget::on_enter_released()
{
...
std::vector<UiWidget*> UiWidget::get_navigation_nodes()
{
	return {this};
}