...
TextToggle::TextToggle(std::string_view text, int x, int y, bool is_checked, sdl::Renderer& renderer, std::function<void(Ui* ui)> callback_function, TextToggleKind texttoggle_kind)
