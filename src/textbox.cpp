...
void Textbox::set_textbox_position(std::string_view where)
{
	if(where == "bottom")
	{
	...
	{
		textbox_.set_position((constants::window_width_ - textbox_.position_.w) / 2, namebox_.position_.h - constants::textbox_y_delta_);
	}
	else if(where == "topleft")
	{
		textbox_.set_position(0, namebox_.position_.h - constants::textbox_y_delta_);
	}
	else if(where == "topright")
	{
		textbox_.set_position(constants::window_width_ - textbox_.position_.w, namebox_.position_.h - constants::textbox_y_delta_);
	}
	else if(where == "bottomleft")
	{
		textbox_.set_position(0, constants::window_height_ - textbox_.position_.h + constants::textbox_y_delta_);
	}
