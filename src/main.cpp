...
int main([[maybe_unused]] int argc, [[maybe_unused]] char* argv[]) //mandatory to use argc and argv for SDL2
{
	...
	game.clear_persistent_variables();
	...
	game.show_dialogue("Where are you " + game.get_persistent_variable_value_string("girl_name") + "...");
	game.edit_persistent_variable("girl_name", "Sayonika");
	game.show_dialogue("Heu... I was talking about " + game.get_persistent_variable_value_string("girl_name") + "!");
